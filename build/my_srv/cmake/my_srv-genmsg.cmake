...
message(STATUS "my_srv: 0 messages, 2 services")
...
get_filename_component(_filename "/home/my_ros_ws/src/my_srv/srv/Harmonic.srv" NAME_WE)
add_custom_target(_my_srv_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "my_srv" "/home/my_ros_ws/src/my_srv/srv/Harmonic.srv" ""
)

get_filename_component(_filename "/home/my_ros_ws/src/my_srv/srv/Velocity.srv" NAME_WE)
add_custom_target(_my_srv_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "my_srv" "/home/my_ros_ws/src/my_srv/srv/Velocity.srv" ""
)
